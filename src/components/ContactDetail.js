...
const ContactDetail =(props) => {
	const {id, nombre, email, etapamaternidad} = props.location.state.contact;
	...
	<div className="main">
		...
		<div className="intereses">
            ...
            <div className="">
				...
				<Link to={{pathname: '/contact2/${id}', state:{contact:props.location.state.contact}}}>
				
					<div className="header">{email}</div>
					<div className="header">{etapamaternidad}</div>
				</Link>
